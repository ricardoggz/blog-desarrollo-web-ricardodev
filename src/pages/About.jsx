...
export const About = () => {
    return (
        <section className="flex-container">
            ...
            <p>En este pequeño proyecto he decicido plasmar todo lo que he aprendido sobre el lenguaje de JavaScript y el desarrollo web en general, espero que te ayude en tu formación como desarrollador y que sea de tu agrado leer cada uno de estos artículos redactados por mí.</p>
